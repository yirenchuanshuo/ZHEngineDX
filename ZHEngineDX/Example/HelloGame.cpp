...
void HelloGame::LoadPipeline()
{
	...
	//设置围栏
	RenderPreSent(swapChain, rtvHandle);
...
void HelloGame::RenderPreSent(ComPtr<IDXGISwapChain1>& swapChain, CD3DX12_CPU_DESCRIPTOR_HANDLE& rtvHandle)
{
...
void HelloGame::CreateRootSignature()
{
	...
	//创建静态采样器
	D3D12_STATIC_SAMPLER_DESC sampler = CreateSamplerDesCribe();
...
D3D12_STATIC_SAMPLER_DESC HelloGame::CreateSamplerDesCribe()
{
